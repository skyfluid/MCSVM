...
clc
close all
load('../CrossValid_MCSVM_10Class_test_50binsize_16u.mat');
...
figure;
boxplot(avgHR);
title(['Accuracy of Multi-Class SVM (16u 300pc)']);
xlabel('Number of PCs'); ylabel('Accuracy (%)');
saveas(gcf, ['./Accuracy_box_50bs_16u_300pc.jpg'], 'jpg');
%{
figure;
boxplot(avgpHR);
...
figure;
boxplot(avgvarcov);
title(['Variance Coverage of Multi-Class SVM (16u 300pc)']);
xlabel('Number of PCs'); ylabel('Variance Coverage');
saveas(gcf, ['./Varcov_box_50bs_16u_300pc.jpg'], 'jpg');    
